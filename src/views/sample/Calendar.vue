      ...
      <div style="width: 80%">
         <div class="row">
            <div class="col q-pa-md q-gutter-sm">
               <q-btn color="primary" label="Today" @click="onToday"></q-btn>
               <q-btn color="secondary" label="Prev" @click="onPrev"></q-btn>
               <q-btn color="deep-orange" glossy label="Next" @click="onNext"></q-btn>
            </div>
            <div class="col q-pa-md q-gutter-sm text-h5" style="text-align: right">
